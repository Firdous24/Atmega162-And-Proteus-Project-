...
HD_PWD='C:/Users/student/projectdsd/projectdsd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Temp_sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Temp_sensor.tcl
