...
HD_PWD='C:/Users/student/projectdsd/projectdsd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Temp_sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Temp_sensor.tcl -notrace
